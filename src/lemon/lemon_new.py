...
class Sense(object):
    ...
    reference: Optional[Union[Reference, str]] = None
...
LEMON = Union[LexicalEntry, Sense, SynBehavior, PartOfSpeech, CanonicalForm, OtherForm, Condition, SubjOfProp, Reference, ObjOfProp, PrepositionalAdjunct, Subject, DirectObject, VerbFormMood, Person, Tense, Number, Marker, OnProperty, Degree]